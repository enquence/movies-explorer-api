...
const UserSchema = new mongoose.Schema({
  email: {
    ...
    required: [true, validateMassages.fieldRequired('email')],
    unique: [true, validateMassages.DUPLICATE_EMAIL],
  },
  password: {
    type: String,
    required: [true, validateMassages.fieldRequired('password')],
    select: false,
  },
  name: {
    type: String,
    required: [true, validateMassages.fieldRequired('name')],
